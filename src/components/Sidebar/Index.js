        ...
        <nav className="mt-5 py-4 px-4 lg:mt-0 lg:px-6">
          <div>
            <ul className="mb-6 flex flex-col gap-1.5">
              <li>
                <Link
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 false text-slate-100 dark:bg-meta-4 ${currentRoute === '/dashboard' && 'bg-graydark'}`}
                  href="/dashboard"
                >
                  <svg
                    className="fill-current"
              ...
              <li>
                <Link
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 false text-slate-100 ${currentRoute.indexOf("/dashboard/invoice") > -1 && 'bg-graydark'}`}
